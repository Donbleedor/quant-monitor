...
```text
E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\asset_work\
  raw_generated\
    first_screen_p0\
      ...
  processed\
...
```text
E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\asset_work\scripts\process_first_screen_assets.py
```
...
--raw E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\asset_work\raw_generated\first_screen_p0
--out E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\asset_work\processed\first_screen_p0
--report E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\asset_work\reports
--priority P0
```
