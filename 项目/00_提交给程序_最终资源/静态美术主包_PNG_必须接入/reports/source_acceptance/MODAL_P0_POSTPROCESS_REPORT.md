...
Paths:
- Contact sheet: `E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\modal_work\review\modal_p0\modal_p0_review_contact_sheet.png`
- Fix compare: `E:\参考图\麻将\项目\99_可能可删除_过程归档\生产工作区_过程产物\modal_work\review\modal_p0\modal_p0_fix_compare.png`
