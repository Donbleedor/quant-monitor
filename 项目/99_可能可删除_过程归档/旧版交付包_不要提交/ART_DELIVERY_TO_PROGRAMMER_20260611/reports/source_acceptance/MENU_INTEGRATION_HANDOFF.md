...
- `bg_game_1080x2400.png` currently comes from `E:\参考图\麻将\项目\asset_work\processed\first_screen_p0\bg_game_1080x2400.png`
...
- future preferred shared location: `E:\参考图\麻将\项目\asset_work\processed\shared\bg_game_1080x2400.png`
...
- `logo_tribal_tiles.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p0\logo_tribal_tiles.png`
  - Size: `760x420`
  - Alpha: yes
  - Priority: `P0`
...
- `button_play_large.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p0\button_play_large.png`
  - Size: `780x260`
  - Alpha: yes
  - Priority: `P0`
...
- `icon_settings.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p0\icon_settings.png`
  - Size: `88x88`
  - Alpha: yes
  - Priority: `P0`
...
- `title_tribal_tiles.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\title_tribal_tiles.png`
  - Size: `620x160`
  - Alpha: yes
  - Priority: `P1`
...
- `icon_levels.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\icon_levels.png`
  - Size: `88x88`
  - Alpha: yes
  - Priority: `P1`
...
- `icon_daily.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\icon_daily.png`
  - Size: `88x88`
  - Alpha: yes
  - Priority: `P1`
...
- `tool_btn_shell.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\tool_btn_shell.png`
  - Size: `182x182`
  - Alpha: yes
  - Priority: `P1`
...
- `badge_count_coin.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\badge_count_coin.png`
  - Size: `44x44`
  - Alpha: yes
  - Priority: `P1`
...
- `tile_base_ivory.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\tile_base_ivory.png`
  - Size: `168x201`
  - Alpha: yes
  - Priority: `P1`
...
- `menu_pattern_overlay.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\menu_pattern_overlay.png`
  - Size: `1080x2400`
  - Alpha: yes
  - Priority: `P1`
...
- `menu_vignette_top.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\menu_vignette_top.png`
  - Size: `1080x520`
  - Alpha: yes
  - Priority: `P1`
...
- `menu_vignette_bottom.png`
  - Path: `E:\参考图\麻将\项目\menu_work\processed\menu_p1\menu_vignette_bottom.png`
  - Size: `1080x620`
  - Alpha: yes
  - Priority: `P1`
