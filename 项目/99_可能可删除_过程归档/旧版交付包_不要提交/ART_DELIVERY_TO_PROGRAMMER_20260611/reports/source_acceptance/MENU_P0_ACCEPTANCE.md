...
- `E:\参考图\麻将\项目\menu_work\processed\menu_p0`
- `E:\参考图\麻将\项目\menu_work\review\menu_p0`
- `E:\参考图\麻将\项目\menu_work\reports\MENU_P0_POSTPROCESS_REPORT.md`
- `E:\参考图\麻将\项目\menu_work\reports\MENU_P0_POSTPROCESS_REPORT.json`

## P0 Coverage Check

P0 assets in the menu spec are covered:

- `bg_game_1080x2400.png` is available as the shared menu background from the existing first-screen pipeline at `E:\参考图\麻将\项目\asset_work\processed\first_screen_p0\bg_game_1080x2400.png`.
